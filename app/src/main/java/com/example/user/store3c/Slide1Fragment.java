...
public class Slide1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        row = inflater.inflate(R.layout.fragment_slide1, container, false);
        image = row.findViewById(R.id.imageView2);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            //Toast.makeText(getActivity(), "The fragment 1 ", Toast.LENGTH_SHORT).show();
        } else {
