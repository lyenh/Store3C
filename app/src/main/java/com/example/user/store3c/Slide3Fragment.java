 ...
 * {@link Slide3Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Slide3Fragment#newInstance} factory method to
...
public class Slide3Fragment extends Fragment {
    ...
    public Slide3Fragment(byte[] param1, String param2) {
        gParam1 = param1;
        Bundle args = new Bundle();
        args.putString("param2", param2);
        Slide3Fragment.this.setArguments(args);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        row = inflater.inflate(R.layout.fragment_slide3, container, false);
        image = row.findViewById(R.id.imageView4);
